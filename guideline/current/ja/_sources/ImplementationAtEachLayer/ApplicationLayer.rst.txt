...
| \ ``<form:xxx>``\ タグの詳細は、 `Spring Framework Documentation -Spring’s form tag library- <https://docs.spring.io/spring-framework/docs/5.3.24/reference/html/web.html#mvc-view-jsp-formtaglib>`_\ を参照されたい。
...
本章では代表的なJSPタグライブラリの使い方は説明しているが、全てのJSPタグライブラリの説明はしていないので、詳細な使い方については、それぞれのドキュメントを参照すること。
 ...
 .. list-table::
   ...
   * - 1.
     ...
     - - `<https://docs.spring.io/spring-framework/docs/5.3.24/reference/html/web.html#mvc-view-jsp-formtaglib>`_\
   * - 2.
     - Spring's JSP Tag Library
     - - `<https://docs.spring.io/spring-framework/docs/5.3.24/reference/html/web.html#mvc-view-jsp-tags>`_\
   * - 3.
     - JSTL
...
.. note::
    \ ``<form:form>``\ 、\ ``<form:xxx>``\ タグの詳細は、 `Spring Framework Documentation -Spring’s form tag library- <https://docs.spring.io/spring-framework/docs/5.3.24/reference/html/web.html#mvc-view-jsp-formtaglib>`_\ を参照されたい。
