...
List of OSS being used in version 5.3.1.RELEASE.
...
.. tip::
    ...
    * Spring Framework compatible OSS library
    ...
    Furthermore, Spring IO platform version is `Athens-SR2 <http://docs.spring.io/platform/docs/Athens-SR2/reference/htmlsingle/>`_  specified in version 5.3.1.RELEASE.
