...
| ファイルのアップロードは、Servlet 3.0からサポートされたファイルアップロード機能と、Spring Webから提供されているクラスを利用して行う。
 ...
 .. note::
    ...
    version 5.3.1.RELEASE時点で問題の発生が確認されているアプリケーションサーバは以下の通りである。
...
.. warning::
    ...
    なお、TERASOLUNA Server Framework for Java version 5.3.1.RELEASEが準拠しているSpring IO Platform Athens-SR2.RELEASEで管理されているバージョンを使用すれば、CVE-2014-0050およびCVE-2016-3092で報告されている脆弱性は発生しない。
