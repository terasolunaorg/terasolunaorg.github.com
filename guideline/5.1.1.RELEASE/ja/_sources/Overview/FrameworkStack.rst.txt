...
version 5.1.1.RELEASEで利用するOSSの一覧を以下に示す。
...
.. tip::
    ...
    * Spring Frameworkと相性のよいOSSライブラリ
    ...
    なお、version 5.1.1.RELEASEで指定しているSpring IO platformのバージョンは、`2.0.1.RELEASE <http://docs.spring.io/platform/docs/2.0.1.RELEASE/reference/htmlsingle/>`_\ である。
