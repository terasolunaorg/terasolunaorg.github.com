...
#. \ :url_tutorial:`tutorial-apps <>`\ にアクセスする。
...
.. tabs::
  .. group-tab:: Java Config
    ...
    .. tabs::
      .. group-tab:: JSP
        アプリケーションサーバ起動後、\ :url_session_tutorial:`session-tutorial-init-jsp-web`\ にアクセスすると以下の画面が表示される。

      .. group-tab:: Thymeleaf
        アプリケーションサーバ起動後、\ :url_session_tutorial:`session-tutorial-init-thymeleaf-web`\ にアクセスすると以下の画面が表示される。

  .. group-tab:: XML Config

    .. tabs::
      .. group-tab:: JSP
        アプリケーションサーバ起動後、\ :url_session_tutorial:`session-tutorial-init-xmlconfig-jsp-web`\ にアクセスすると以下の画面が表示される。

      .. group-tab:: Thymeleaf
        アプリケーションサーバ起動後、\ :url_session_tutorial:`session-tutorial-init-xmlconfig-thymeleaf-web`\ にアクセスすると以下の画面が表示される。
    ...
    .. code-block:: jsp
      ...
      <html class="no-js">
          <head>
              ...
              <link rel="stylesheet" href="${pageContext.request.contextPath}/webjars/bootstrap/css/bootstrap.css" media="screen, projection" />
          </head>
          <body>
              <div class="container">
                      ...
                      <form:form action="${pageContext.request.contextPath}/account/update" method="post" modelAttribute="accountUpdateForm">
                          ...
                          <table>
                              ...
                              <tr>
                                  ...
                                  <td>
                                      <javatime:format value="${accountUpdateForm.birthday}" pattern="yyyy-MM-dd" var="formattedBirthday" />
                              ...
                              <tr>
                                  ...
                                  <td>
                                      <form:input path="zip" cssErrorClass="error-input" />
                  ...
                  <form th:action="@{/account/update}" method="post" th:object="${accountUpdateForm}">
                      ...
                      <table>
                          ...
                          <tr>
                              ...
                              <td>
                                  <input type="date" name="birthday" id="birthday" th:value="${#temporals.format(accountUpdateForm.birthday, 'yyyy-MM-dd')}" />
                      ...
                      <form:form action="${pageContext.request.contextPath}/account/update" method="post" modelAttribute="accountUpdateForm">
                          ...
                          <table>
                              <tr>
                                  ...
                                  <td>
                                      <form:input path="cardNumber" cssErrorClass="error-input" />
                              ...
                              <tr>
                                  ...
                                  <td>
                                      <javatime:format value="${accountUpdateForm.cardExpirationDate}" pattern="yyyy-MM" var="formattedCardExpirationDate" />
                              ...
                              <tr>
                                  ...
                                  <td>
                                      <form:input path="cardSecurityCode" cssErrorClass="error-input" />
                  ...
                  <form th:action="@{/account/update}" method="post" th:object="${accountUpdateForm}">
                      ...
                      <table>
                          ...
                          <tr>
                              ...
                              <td>
                                  <input type="month" name="cardExpirationDate" id="cardExpirationDate" th:value="${#temporals.format(accountUpdateForm.cardExpirationDate, 'yyyy-MM')}" />
                      ...
                      <form:form action="${pageContext.request.contextPath}/account/update" method="post">
                          ...
                          <table>
                              ...
                              <tr>
                                  ...
                                  <td id="birthday"><javatime:format value="${accountUpdateForm.birthday}" pattern="yyyy-MM-dd" /></td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                  ...
                                  <td id="cardExpirationDate"><javatime:format value="${accountUpdateForm.cardExpirationDate}" pattern="yyyy-MM" /></td>
                              </tr>
                              <tr>
              ...
              <div class="container">
                  <form th:action="@{/account/update}" method="post">
                      ...
                      <table th:object="${accountUpdateForm}">
                          ...
                          <tr>
                              <td><label for="birthday">birthday</label></td>
                              <td id="birthday" th:text="*{#temporals.format(birthday, 'yyyy-MM-dd')}"></td>
                          </tr>
                          <tr>
                              <td><label for="zip">zip</label></td>
                          ...
                          <tr>
                              <td><label for="cardExpirationDate">expiration date of your card</label></td>
                              <td id="cardExpirationDate" th:text="*{#temporals.format(cardExpirationDate, 'yyyy-MM')}"></td>
                          </tr>
                          <tr>
                              <td><label for="cardSecurityCode">security code of your card</label></td>
              ...
              <div class="container">
                  ...
                  <div>
                      ...
                      <table>
                          ...
                          <tr>
                              <td><label for="birthday">birthday</label></td>
                              <td id="birthday"><javatime:format value="${account.birthday}" pattern="yyyy-MM-dd" /></td>
                          </tr>
                          <tr>
                              <td><label for="zip">zip</label></td>
                          ...
                          <tr>
                              <td><label for="cardExpirationDate">expiration date of your card</label></td>
                              <td id="cardExpirationDate"><javatime:format value="${account.cardExpirationDate}" pattern="yyyy-MM" /></td>
                          </tr>
                          <tr>
                              <td><label for="cardSecurityCode">security code of your card</label></td>
          ...
          <body>
              ...
              <div class="container">
                  ...
                  <div class="paginationPart" th:object="${page}">
                      <ul th:if="*{totalElements} != 0" class="pagination" th:with="disabledHref = 'javascript:void(0)', currentUrl = ${requestURI}">
                  ...
                  <div>
                      ...
                      <table>
                          ...
                          <tr>
                              ...
                              <td id="orderDate"><javatime:format value="${order.orderDate}" pattern="yyyy-MM-dd HH:mm:ss" /></td>
                          </tr>
                      </table>
                      <table>
                          <tr>
          ...
          <body>
              ...
              <div>
                  ...
                  <table>
                      ...
                      <tr>
                          <td><label for="orderDate">order date</label></td>
                          <td id="orderDate" th:text="${#temporals.format(order.orderDate, 'yyyy-MM-dd　HH:mm:ss')}"></td>
                      </tr>
                  </table>
                  <table>
                      <tr>
