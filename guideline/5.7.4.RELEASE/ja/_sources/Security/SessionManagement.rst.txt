...
.. note:: **URL Rewriting**
    ...
    * \ ``HttpServletResponse#encodeRedirectURL(String)``\
    ...
    詳細は、\ `StrictHttpFirewall#setAllowSemicolon <https://docs.spring.io/spring-security/site/docs/5.7.13/api/org/springframework/security/web/firewall/StrictHttpFirewall.html#setAllowSemicolon(boolean)>`_\ を参照されたい。
