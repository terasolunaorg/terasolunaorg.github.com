...
.. list-table::
    ...
    * - | (4)
      - | エラーメッセージの内容を確認するために、\ ``MessageSource``\ の実装クラスである
          ...
          クラスの詳細については、
          \ `ResourceBundleMessageSourceのJavadoc <https://docs.spring.io/spring/docs/5.2.12.RELEASE/javadoc-api/org/springframework/context/support/ResourceBundleMessageSource.html>`_\
          を参照されたい。
    * - | (5)
