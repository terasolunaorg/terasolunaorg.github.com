 ...
 .. list-table::
    ...
    * - | (1)
      - | locationに設定する値は、リソースのロケーションパスを設定すること。
        ...
        | locationの設定値の詳細は、\ `Spring Framework Documentation -Resources- <https://docs.spring.io/spring/docs/5.2.12.RELEASE/spring-framework-reference/core.html#resources>`_\ を参照されたい。
