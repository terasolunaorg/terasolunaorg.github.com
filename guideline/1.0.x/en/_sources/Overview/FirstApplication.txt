...
In Spring MVC, \ `Bean Validation <http://jcp.org/en/jsr/detail?id=303>`_\  and annotation based input validation can be easily implemented. For example input validation of name is performed in Eco Application.
