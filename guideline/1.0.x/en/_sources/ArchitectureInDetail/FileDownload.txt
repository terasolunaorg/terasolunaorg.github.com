...
| For technical details on View, refer to \ `Spring Reference View technologies <http://static.springsource.org/spring/docs/3.2.x/spring-framework-reference/html/view.html>`_\ .
...
\
    .. tip::
            ...
            For details, refer to the official Spring website  \ `Spring reference <http://static.springsource.org/spring/docs/3.2.x/spring-framework-reference/html/view.html#view-jasper-reports>`_\ .
