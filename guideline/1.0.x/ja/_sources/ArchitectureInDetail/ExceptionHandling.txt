...
- ExampleExceptionController.java
 ...
 .. code-block:: java
    ...
    package org.terasoluna.exception.app.example;
    ...
    import org.terasoluna.exception.domain.service.ExampleExceptionService;

    @Controller
    public class ExampleExceptionController {

        @Inject
        protected ExampleExceptionService exampleExceptionService;

        @RequestMapping(value = "/exampleException", method = { RequestMethod.GET,
                RequestMethod.POST })
        public String exampleBusinessException() {

            exampleExceptionService.throwBusinessException();
...
- ExampleExceptionServiceImpl.java

 .. code-block:: java

    package org.terasoluna.exception.domain.service;
    ...
    public class ExampleExceptionServiceImpl implements ExampleExceptionService {
        ...
        public void throwBusinessException() {
            throw new BusinessException("Test example exception");
        }
...
- ログ出力
 ...
 .. code-block:: guess
    ...
    date:2013-09-24 22:35:56	thread:tomcat-http--8	X-Track:30603b739d2e473886fae7230589b437	level:WARN 	logger:o.t.gfw.common.exception.ExceptionLogger        	message:[e.xx.fw.8001] ResultMessages [type=error, list=[ResultMessage [code=null, args=[], text=Test example exception]]]
    org.terasoluna.gfw.common.exception.BusinessException: ResultMessages [type=error, list=[ResultMessage [code=null, args=[], text=Test example exception]]]
    	at org.terasoluna.exception.domain.service.ExampleExceptionServiceImpl.throwBusinessException(ExampleExceptionServiceImpl.java:11) ~[ExampleExceptionServiceImpl.class:na]

    // stackTarace ommited
    ...

    date:2013-09-24 22:35:56	thread:tomcat-http--8	X-Track:30603b739d2e473886fae7230589b437	level:DEBUG	logger:o.t.gfw.web.exception.SystemExceptionResolver   	message:Resolving exception from handler [public java.lang.String org.terasoluna.exception.app.example.ExampleExceptionController.home(java.util.Locale,org.springframework.ui.Model)]: org.terasoluna.gfw.common.exception.BusinessException: ResultMessages [type=error, list=[ResultMessage [code=null, args=[], text=Test example exception]]]
    ...
    date:2013-09-24 22:35:56	thread:tomcat-http--8	X-Track:30603b739d2e473886fae7230589b437	level:DEBUG	logger:o.t.gfw.web.exception.SystemExceptionResolver   	message:Applying HTTP status code 409
