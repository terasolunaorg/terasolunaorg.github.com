...
**戻り値**
 ...
 .. note:: **クエリ文字列への変換ルール**
    ...
    **[リクエストパラメータ値]**
    ...
    詳細は\ `WebDataBinder#getEmptyValueのJavadoc <https://docs.spring.io/spring/docs/5.3.18/javadoc-api/org/springframework/web/bind/WebDataBinder.html#getEmptyValue-java.lang.Class->`_\を参照されたい。
