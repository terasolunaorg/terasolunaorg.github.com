...
.. list-table::
    ...
    * - :doc:`../Security/CSRF`
      - CSRF(Cross site request forgeries) Check
      - Provide mechanism (classes) for protecting Web Application from attack using CSRF.
        (Interim measure until the introduction of Spring Security 3.2)
