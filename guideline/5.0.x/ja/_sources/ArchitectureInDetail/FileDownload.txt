...
| Viewの技術詳細は、\ `Spring Reference View technologies <http://docs.spring.io/spring/docs/4.1.4.RELEASE/spring-framework-reference/html/view.html>`_\ を参照されたい。
...
\
    .. tip::
        ...
        詳細は、Spring の公式ドキュメント\ `Spring reference <http://docs.spring.io/spring/docs/4.1.4.RELEASE/spring-framework-reference/html/view.html#view-jasper-reports>`_\ を参照されたい。
