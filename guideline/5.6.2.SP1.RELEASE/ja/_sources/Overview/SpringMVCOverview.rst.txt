...
`Spring Framework Documentation <https://docs.spring.io/spring/docs/5.2.20.RELEASE/spring-framework-reference/web.html#mvc>`_\ .
...
| (\ ``<mvc:annotation-driven>``\ アノテーションで有効になる設定は、\ `Spring Framework Documentation -Enable MVC Configuration- <https://docs.spring.io/spring/docs/5.2.20.RELEASE/spring-framework-reference/web.html#mvc-config-enable>`_\ を参照されたい。)
