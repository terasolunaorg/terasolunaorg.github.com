...
| Viewの技術詳細は、\ `Spring Reference View technologies <http://static.springsource.org/spring/docs/3.2.16.RELEASE/spring-framework-reference/html/view.html>`_\ を参照されたい。
...
\
    .. tip::
        ...
        詳細は、Spring の公式ドキュメント\ `Spring reference <http://static.springsource.org/spring/docs/3.2.16.RELEASE/spring-framework-reference/html/view.html#view-jasper-reports>`_\ を参照されたい。
