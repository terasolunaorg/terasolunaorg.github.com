...
* For correlated items check, \ `BeanValidation <http://download.oracle.com/otn-pub/jcp/bean_validation-1_1-fr-eval-spec/bean-validation-specification.pdf>`_\  or \ `Spring Validation <http://docs.spring.io/spring/docs/4.1.9.RELEASE/spring-framework-reference/html/validation.html>`_  is used.
...
List of OSS being used in version 5.0.2.RELEASE.
...
.. tip::
    ...
    * Spring Framework compatible OSS library
    ...
    Furthermore, Spring IO platform version is `1.1.5.RELEASE <http://docs.spring.io/platform/docs/1.1.5.RELEASE/reference/htmlsingle/>`_  specified in version 5.0.2.RELEASE.
