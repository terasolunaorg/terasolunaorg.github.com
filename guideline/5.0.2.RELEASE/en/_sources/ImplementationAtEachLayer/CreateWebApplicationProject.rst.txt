...
.. list-table::
    ...
    * - | (1)
      - Project created in Maven Archetype.
        ...
        In the project created in version 5.0.2.RELEASE Maven Archetype,
        [org.terasoluna.gfw:terasoluna-gfw-parent:5.0.2.RELEASE] is specified as a parent project.
    * - | (2)
