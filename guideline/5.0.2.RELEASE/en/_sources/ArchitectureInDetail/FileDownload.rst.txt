...
| For technical details on View, refer to \ `Spring Reference View technologies <http://docs.spring.io/spring/docs/4.1.9.RELEASE/spring-framework-reference/html/view.html>`_\ .
...
\
    ...
    .. tip::
            ...
            For details, refer to the official Spring website  \ `Spring reference <http://docs.spring.io/spring/docs/4.1.9.RELEASE/spring-framework-reference/html/view.html#view-jasper-reports>`_\ .
