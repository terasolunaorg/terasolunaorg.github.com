...
* spring-mvc.xml
  ...
  \
      ...
      .. note::
          ...
          \ `Expression-Based Access Control <http://docs.spring.io/spring-security/site/docs/3.2.9.RELEASE/reference/htmlsingle/#el-access>`_\
...
For details, refer to \ `Official reference <http://docs.spring.io/spring-security/site/docs/3.2.9.RELEASE/reference/htmlsingle/#default-security-headers>`_\ .
