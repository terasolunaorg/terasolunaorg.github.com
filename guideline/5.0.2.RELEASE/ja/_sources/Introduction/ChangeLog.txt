...
.. list-table::
    ...
    * -
      ...
      - 利用するOSSのバージョン(Spring IO Platformのバージョン)を更新
        ...
        * 使用するOSSのバージョンを更新。更新内容は、\ `version 5.0.2の移行ガイド <https://github.com/terasolunaorg/terasoluna-gfw/wiki/Migration-Guide-5.0.2_ja#step-1-update-dependency-libraries>`_\ を参照されたい。
