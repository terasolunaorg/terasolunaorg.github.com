...
.. list-table::
    ...
    * -
      ...
      - CVE-2018-1199への対応のため、利用するOSSのバージョンを更新(管理ID#3300)
        ...
        * Spring Securityのバージョンを4.1.5に更新 
    ...
    * -
      ...
      - 記載内容の追加
        ...
        * パスワードを\ ``StandardPasswordEncoder`` \によるハッシュ化によって管理する場合の注意事項を追加(管理ID#2092)
    ...
    * -
      ...
      - 記載内容の追加
        ...
        * アプリケーションサーバによってはCache-Controlヘッダが正しく設定されない問題についての注意事項を追加(管理ID#2913)
    ...
    * -
      ...
      - Spring Framework 4.1対応に伴う修正
        ...
        * 「読み取り専用のトランザクション」が有効にならないケースに関する注意点を追加。(管理ID#861)
    * -
    ...
    * -
      ...
      - ガイドラインのバグ修正
        ...
        * Spring Validatorを使用した相関項目チェック時に、Bean ValidationのGroup Validationの仕組みと連携する方法を追加。(管理ID#320)
    ...
    * -
      ...
      - 記載内容の追加
        ...
        * 513バイトより小さいサイズのエラーレスポンスを返すとInternet Explorerで簡易エラーページが表示される可能性がある旨の説明を追加。(管理ID#189)
    ...
    * -
      ...
      - 記載内容の改善
        ...
        * Locationヘッダやハイパーメディアリンクに設定するURLを組み立てる方法を改善。(管理ID#374)
    ...
    * -
      ...
      - ガイドラインのバグ修正
        ...
        * 一部のアプリケーションサーバでServlet 3のファイルアップロード機能が文字化けする問題があるため、この事象の回避策としてApache Commons FileUploadを使用する方法を追加。(管理ID#778)
    * -
    ...
    * -
      ...
      - 記載内容の追加
        ...
        * \ ``LocalDateTime``\ の使い方を追加。(管理ID#584)
