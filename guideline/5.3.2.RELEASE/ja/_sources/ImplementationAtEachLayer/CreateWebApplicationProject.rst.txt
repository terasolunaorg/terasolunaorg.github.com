...
.. code-block:: console
    ...
    (... omit)
    [INFO] ----------------------------------------------------------------------------
    [INFO] Using following parameters for creating project from Archetype: terasoluna-gfw-multi-web-blank-mybatis3-archetype:5.3.2.RELEASE
    [INFO] ----------------------------------------------------------------------------
...
.. list-table::
    ...
    * - | (1)
      - Maven Archetypeで作成したプロジェクト。
        ...
        version 5.3.2.RELEASE用のMaven Archetypeで作成したプロジェクトでは、
