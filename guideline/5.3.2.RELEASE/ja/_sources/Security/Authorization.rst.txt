...
.. [#fSpringSecurityAuthorization1] ドメインオブジェクトのアクセスに対する認可処理については、 \ `Spring Security Reference -Domain Object Security (ACLs)- <http://docs.spring.io/spring-security/site/docs/4.1.5.RELEASE/reference/htmlsingle/#domain-acls>`_\ を参照されたい。
...
上記以外の属性については、\ `<intercept-url> <http://docs.spring.io/spring-security/site/docs/4.1.5.RELEASE/reference/htmlsingle/#nsa-intercept-url>`_\ を参照されたい。
