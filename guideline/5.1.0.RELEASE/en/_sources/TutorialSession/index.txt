...
Refer to the guideline :doc:'../ArchitectureInDetail/SessionManagement' and
...
The guideline mentions a method to avoid it using transaction token check. However, note that it becomes a low-usability application in this case. \ :doc:`../ArchitectureInDetail/DoubleSubmitProtection`\  should be referred for the specific implementation method.
...
:doc:`../ArchitectureInDetail/SessionManagement` classifies the methods to be used depending on whether the data is contained within 1 Controller.
...
Since the guideline mentions a method of implementing synchronization where BeanProcessor is used in :doc:`../ArchitectureInDetail/SessionManagement`, use this in this tutorial.
...
The guideline mentions a method to handle the requests after session timeout in :doc:`../ArchitectureInDetail/SessionManagement`.
...
Note that since the method to import the project is described in :doc:`../TutorialTodo/index`,
...
since it is described in :doc:`../TutorialTodo/index`.
...
There are 2 types of configuration methods mentioned in :doc:`../ArchitectureInDetail/SessionManagement` as the methods to use the Bean for session scope.
