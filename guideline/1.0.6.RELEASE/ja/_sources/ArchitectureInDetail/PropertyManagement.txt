...
.. note::
    ...
    テスト済みのアプリケーションをプロダクト環境にリリースする方法については、
    「:doc:`../Appendix/EnvironmentIndependency`」を参照されたい。
 ...
 .. list-table::
    ...
    * - | (1)
      - | locationに設定する値は、リソースのロケーションパスを設定すること。
        ...
        | locationの設定値の詳細は、\ `リファレンス <http://docs.spring.io/spring/docs/3.2.18.RELEASE/spring-framework-reference/html/resources.html>`_\ を参照されたい。
